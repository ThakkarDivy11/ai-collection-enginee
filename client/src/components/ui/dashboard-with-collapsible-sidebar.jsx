...
const Sidebar = () => {
  ...
  return (
    <nav
      className={`relative sticky top-0 h-screen shrink-0 border-r transition-all duration-300 ease-in-out ${
        open ? 'w-64' : 'w-16'
    ...
    <div className="flex-1 bg-gray-50 dark:bg-gray-950 p-6 overflow-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="p-0 overflow-hidden rounded-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
            <img 
